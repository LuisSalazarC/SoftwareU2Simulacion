...
public class MainWindows extends JFrame {
    ...
    private void init() {
        String[] options = {"1. Cuadrados medios", "2. Congruencial Multiplicativo", "3. Congruencial Mixto"};

        int option = JOptionPane.showOptionDialog(null, "*METODO DE EJECUCION:* ", "NUMEROS PSEUDOALEATORIOS",
    ...
    private void drawList() {
        ...
        jtList.setText("	" + list.size() + " numeros generados" + text);
    }
    ...
    private void drawKolmogorovSmirnov() {
        ...
        if (ks.estimateUniformity()) {
            KolmogorovSmirnov.setText("Independencia en los numeros aleatorios");
        } else {
    ...
    private void drawStreakTest() {
        ...
        if (streak.acceptIndependence()) {
            StreakTest.setText("Independencia en los numeros aleatorios");
        } else {
